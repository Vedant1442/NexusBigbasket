      ...
      <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl relative animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-8">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    required
                    className="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-all"
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            ...
            <button onClick={toggleMode} className="text-green-600 font-medium hover:underline">
